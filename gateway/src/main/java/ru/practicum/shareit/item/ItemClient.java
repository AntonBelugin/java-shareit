...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(long ownerId, ItemDtoRequest requestDto) {
        return post("", ownerId, requestDto);
    }

    public ResponseEntity<Object> updateItem(long ownerId, long itemId, ItemDtoRequest requestDto) {
        return patch("/" + itemId, ownerId, requestDto);
    }

    public ResponseEntity<Object> addComment(long authorId, long itemId, CommentDtoRequest requestDto) {
